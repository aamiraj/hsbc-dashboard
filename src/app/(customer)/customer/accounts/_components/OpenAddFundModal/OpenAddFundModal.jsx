...
import styles from "./OpenAddFundModal.module.css";
import { useSession } from "next-auth/react";

const OpenAddFundModal = ({ id, account }) => {
        ...
        <div className={styles.modal_content}>
          ...
          <div className={styles.modal_body}>
            <p className="border-b text-center text-base py-4">
              The amount will be added to your available funds upon receipt of
              payment.
            </p>
...
export default OpenAddFundModal;
